...
public class Profesional extends BeanEntidadGenericoAutogenerado implements java.io.Serializable {
	...
	/**
	 * @param categoriaLicenciaDeConducir
	 *            the categoriaLicenciaDeConducir to set
	 */
	...
	private List<Capacitacion> capacitaciones = new ArrayList<Capacitacion>();// camm
	private List<Conocimiento> conocimientos = new ArrayList<Conocimiento>();// camm
	...
	/**
	 * @param codigoOficinaAsociada
	 *            the codigoOficinaAsociada to set
	 */
	...
	public void setExperienciasEspecialidad(List<ExperienciaEspecialidad> experienciasEspecialidad) {
