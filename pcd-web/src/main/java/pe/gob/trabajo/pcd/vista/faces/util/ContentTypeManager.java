...
public final class ContentTypeManager{
   ...
   */
   public ContentTypeManager(){
     ...
     */
    public static String getContenTypeByString( String rutaArchivo ){
            ...
            if( extensionIndex != -1 ){
                ...
                if( extensionIndex + 1 < rutaArchivo.length() ){
                    ...
                    for( int i = 0; i < MIME_TYPE_MAPPINGS.length; i++ ){
                    	 ...
                    	 if( formato.toLowerCase().equals(MIME_TYPE_MAPPINGS[i][0]) ){
     ...
     * @return el 'content type' del archivo y retorna 'null' si no encuentra el formato.
     */
    public static String getContenTypeByFile( File rutaArchivo ){ 
    ...
    public static String getTypeByString( String rutaArchivo ){
            ...
            if( extensionIndex != -1 ){
                ...
                if( extensionIndex + 1 < rutaArchivo.length() ){
                    ...
                    for( int i = 0; i < MIME_TYPE_MAPPINGS.length; i++ ){
                    	 ...
                    	 if( formato.toLowerCase().equals(MIME_TYPE_MAPPINGS[i][0]) ){
                             contentType = MIME_TYPE_MAPPINGS[i][0];
                             break;
                         }
                    }
                }
