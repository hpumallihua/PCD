...
import pe.gob.trabajo.pcd.modelo.dominio.PersonaCondicionesTrabajo;
import pe.gob.trabajo.pcd.modelo.dominio.Profesional;
import pe.gob.trabajo.pcd.servicio.util.Constantes;

/**
 * The Class RegistrarPersonaCondicionesTrabajoMB.
 */
public class RegistrarPersonaCondicionesTrabajoMB extends GenericManagedBean {

	/** The logger. */
	private static Logger logger = Logger.getLogger(RegistrarPersonaCondicionesTrabajoMB.class);
	...
	public void seleccionarProfesional(ActionEvent e) {
		...
		PersonaCondicionesTrabajo personaCondicionesTrabajo = (PersonaCondicionesTrabajo) getServicio().getPersonaService().findObjectByPK(personaBean.getId(), PersonaCondicionesTrabajo.class);
		if (personaCondicionesTrabajo == null) {
			personaCondicionesTrabajo = new PersonaCondicionesTrabajo();
			personaCondicionesTrabajo.setPersona(personaBean);
		}
		personaBean.setPersonaCondicionesTrabajo(personaCondicionesTrabajo);
	...
	public void guardar(ActionEvent e) {
		validar();
		try {
			getServicio().getPersonaService().saveObject(personaBean.getPersonaCondicionesTrabajo());
	...
	public void nuevo(ActionEvent e) {
		...
		PersonaCondicionesTrabajo bean = new PersonaCondicionesTrabajo();
