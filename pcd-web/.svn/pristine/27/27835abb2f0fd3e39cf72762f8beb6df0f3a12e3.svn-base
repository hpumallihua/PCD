 ...
 */
public class RegistrarPedidoDetalleMB extends GenericManagedBean {
	
	/** The logger. */
	private static Logger logger = Logger.getLogger(RegistrarPedidoDetalleMB.class);
	 ...
	 */
	public RegistrarPedidoDetalleMB() {
		init();
	}
